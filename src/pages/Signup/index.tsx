...
import {startGoogleLogin, startSignup} from '../../actions'
import {Link, useHistory, useParams} from 'react-router-dom'
import FacebookSvg from '../../assets/icons/facebook-svgrepo-com.svg'
import {SignupPayload} from '../../services'
...
const SignupPage = () => {
	...
	useEffect(() => {
		!planId || (planId === '' && history.push('/404'))
	}, [planId])
	...
	const handleSubmit = (e: React.FormEvent) => {
		e.preventDefault()
		dispatch(startSignup({...userData, priceId: planId}))
	}
