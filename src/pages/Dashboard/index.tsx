...
const Dashboard: React.FC = () => {
	...
	const [mainFunnel, setMainFunnel] = useState<IFunnel>()
	...
	const handleToggleActivate = useCallback(() => {
		dispatch(startToggleActiveFunnel(mainFunnel?._id))
					...
					<Container>
						...
						<div className='flex flex-col'>
							...
							<ConfirmationModal
								...
								variant='Warning'
								title={`${mainFunnel?.isActive ? 'Deactivate' : 'Activate'} ${mainFunnel?.title}`}
								text={`Are you sure you want to ${mainFunnel?.isActive ? 'Deactivate' : 'Activate'} this funnel?`}
								buttonText='Yes, sure'
								setOpen={() => setActiveModalOpen(false)}
